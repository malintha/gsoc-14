...
function run_test() {
    dump("### Server "+exampleServerObj.id+" started on "+exampleServerObj.getLocalPort());
    do_get_profile();
    registerFakeUMimTyp();
...
function test_doFakeServer(){
    ...
    let calendarURL = 'http://localhost:'+exampleServerObj.getLocalPort()+exampleServerObj._propertyBag.scheduleInboxURL;
